...
export default function Farme2b() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.otherLoginMethods}>Other Login Methods</Text>
      <View style={styles.socialIcons}>
        ...
        />
        <Image
          source={{ uri: 'https://img.icons8.com/ios-filled/50/000000/twitter.png' }} // Twitter icon
          style={styles.icon}
        />
      </View>
    </View>
